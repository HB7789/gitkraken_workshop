...
## Load data
load("~/Desktop/Project Single cell RNAseq/single_cell_rnaseq/Tools for reproducible reseach/data/Rmarkdown_data.Rdata")
```
...
comment: Top 20 DEGs for 3 groups for plotted
...
Comment: knockdown shows a similar expression profile to the control while the Overexpression shows a different profile.
```{r session info}
sessionInfo()
